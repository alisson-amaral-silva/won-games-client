...
const Logo = ({color = 'white', size = 'normal', hideOnMobile}: LogoProps) => (
  <S.Wrapper color={color} size={size} hideOnMobile={hideOnMobile}>
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 158 48" role='img' aria-label="Logo da Won games">
      <path
