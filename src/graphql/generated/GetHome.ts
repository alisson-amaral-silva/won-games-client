...
import { ENUM_COMPONENTPAGERIBBON_COLOR, ENUM_COMPONENTPAGERIBBON_SIZE, ENUM_COMPONENTPAGEHIGHLIGHT_ALLIGNMENT } from "./globalTypes";
...
export interface GetHome_upcommingMoreGames_cover {
  __typename: "UploadFile";
  url: string;
}

export interface GetHome_upcommingMoreGames_developers {
  __typename: "Developer";
  name: string;
}

export interface GetHome_upcommingMoreGames {
  __typename: "Game";
  name: string;
  slug: string;
  cover: GetHome_upcommingMoreGames_cover | null;
  developers: GetHome_upcommingMoreGames_developers[];
  price: number;
}
...
export interface GetHome {
  ...
  upcommingMoreGames: GetHome_upcommingMoreGames[];
